...
import cv2
from model import architecture0315bak
# Testing settings
...
parser.add_argument("--test_hr_folder", type=str, default=Set5,
                    help='the folder of the target images')
parser.add_argument("--test_lr_folder", type=str, default=Set5_LR,
                    help='the folder of the input images')
parser.add_argument("--output_folder", type=str, default=Set5_out)
parser.add_argument("--checkpoint", type=str, default='checkpoints/epoch_0314_module3_lossl1.pth',
...
model = architecture0315bak.CRFN(num_modules=3, upscale=opt.upscale_factor, k=2)
