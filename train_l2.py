...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default=r"/media/a808/beta_2t/SR/dataset",
    ...
    parser.add_argument("--n_train", type=int, default=5800,
    ...
    parser.add_argument("--pretrained", default="checkpoint_x4_42/epoch_1000.pth", type=str,
    ...
    testset = Set5_val.DatasetFromFolderVal("Test_Datasets/Val/",
                                            "Test_Datasets/Val_LR/x{}/".format(args.scale),
                                            args.scale)
    training_data_loader = DataLoader(dataset=trainset, num_workers=args.threads, batch_size=args.batch_size,
    ...
    args.is_train = True
    model = architecture.CRFN(num_modules=module_number,upscale=args.scale,k=K)
