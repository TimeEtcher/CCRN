...
parser.add_argument('--pathFrom', default='/media/a808/beta_2t/SR/datasetx2/DIV2K/DIV2K_train_LR_bicubic/x2',
                    help='directory of images to convert')
parser.add_argument('--pathTo', default='/media/a808/beta_2t/SR/datasetx2/DIV2K_decoded/DIV2K_train_LR_bicubic/x2',
